    ...
    <section className="relative w-full text-white overflow-hidden bg-[#4A0D66]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-0 w-1/2 md:w-2/5 lg:w-1/3 h-full opacity-60 md:opacity-80">
          ...
          <div
            className="absolute bottom-[40%] right-2 text-white font-semibold text-xs sm:text-sm md:text-base opacity-90 drop-shadow-lg transform rotate-90 origin-bottom-right"
            style={{
