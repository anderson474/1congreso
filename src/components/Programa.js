...
const scheduleItems = [
  ...
  },
  {
    ...
    icon: (
      <DoorClosed
        size={24}
        textInside="Palabras de bienvenida – Grupo Educativo Avancemos y Universidad de Medellín.
              ...
              return (
                <div key={index} className="relative mb-8">
                  ...
                  >
                    ...
                    >
                      <div
                        className={`flex-grow ${isOdd ? "text-left" : "text-right"}`}
                      >
                        <p className="text-sm font-medium text-[#305398]">
                          {item.time}
                        </p>
