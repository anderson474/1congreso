...
const ejes = [
  {
    icon: <Book className="w-8 h-8 text-[#305398]" />,
  ...
  {
    icon: <Cpu className="w-8 h-8 text-[#305398]" />,
  ...
  {
    icon: <Users className="w-8 h-8 text-[#305398]" />,
  ...
  {
    icon: <FileSearch className="w-8 h-8 text-[#305398]" />,
...
export default function EjesTematicos() {
  return (
    <section className="py-16 px-6 bg-white">
      <h2 className="text-3xl font-bold text-center text-[#305398] mb-12">
        Ejes Temáticos
      </h2>
        ...
        {ejes.map((eje, index) => (
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              {eje.icon}
              <h3 className="text-xl font-semibold text-[#305398]">{eje.title}</h3>
            </div>
